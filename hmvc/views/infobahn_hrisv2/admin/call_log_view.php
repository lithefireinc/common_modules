 ...
 call_log.app = function()
 {
 	return{
 		...
 		getGrid: function()
 		{
 			...
 			var memoGrid = new Ext.grid.GridPanel({
 				id: 'memogrid',
 				height: 422,
 				width: '100%',
 				border: true,
 			...
 			call_log.app.memoGrid = memoGrid;
 			call_log.app.memoGrid.getStore().load({params:{start: 0, limit: 25}});

                        var notificationStore = new Ext.data.Store({
 						proxy: new Ext.data.HttpProxy({
 			...
 			var notificationGrid = new Ext.grid.GridPanel({
 				id: 'notificationgrid',
 				height: 422,
 				width: '100%',
 				border: true,
 				ds: notificationStore,
 				cm:  new Ext.grid.ColumnModel(
 						[
 						  { header: "Id", dataIndex: "id", width: 100, sortable: true},
 						  { header: "Employee Name", width: 200, sortable: true, dataIndex: "employee_name" },
 			...
 			call_log.app.notificationGrid = notificationGrid;
 			call_log.app.notificationGrid.getStore().load({params:{start: 0, limit: 25}});

                        var suspensionStore = new Ext.data.Store({
 						proxy: new Ext.data.HttpProxy({
 			...
 			var suspensionGrid = new Ext.grid.GridPanel({
 				id: 'suspensiongrid',
 				height: 422,
 				width: '100%',
 				border: true,
 				...
 				tbar: [
 					    {
							...
							icon: '/images/icons/application_delete.png',
 							cls:'x-btn-text-icon',
 					     	...
 					     	handler: call_log.app.suspensionDelete

 					 	}
 	    			 ]
 	    	});

 			call_log.app.suspensionGrid = suspensionGrid;
