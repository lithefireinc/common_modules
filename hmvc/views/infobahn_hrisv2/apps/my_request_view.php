				...
				},'   ', new Ext.app.SearchField({ store: Objstore, width:250}),
 					    {
 					     	xtype: 'tbfill'
 					 	},
                                                {
                                                    xtype: 'tbbutton',
                                                    text: 'APPLY',
                                                    icon: '<?php echo base_url(); ?>/images/icons/application_form_add.png',
                                                    handler: requests.app.applyLeave
                                                }, '-',
                                                {
                                                    xtype: 'tbbutton',
                                                    text: 'VIEW',
                                                    icon: '<?php echo base_url(); ?>/images/icons/application_form_magnify.png',
                                                    handler: requests.app.view_application
                                                }, '-',
                                                {
                                                    xtype: 'tbbutton',
                                                    text: 'VOID',
                                                    icon: '<?php echo base_url(); ?>/images/icons/application_form_delete.png',
                                                    handler: function(){
		...
		var overtimeGrid = new Ext.grid.GridPanel({
     	...
     	bbar:
     		new Ext.PagingToolbar({
			        ...
			        store: overtimeStore,
			        displayInfo: true,
			        displayMsg: 'Displaying Results {0} - {1} of <span style="font-weight: bold; font-size: 12pt">{2}</span>',
			        emptyMsg: "No Data Found."
			    }),
			tbar: [new Ext.form.ComboBox({
            fieldLabel: 'Search',
