 				...
 				tbar: [new Ext.form.ComboBox({
					...
					text:'Search:'
				},'   ', new Ext.app.SearchField({ store: Objstore, width:250}),
 					    {
 					     	...
 					     	xtype: 'tbbutton',
 					     	text: 'ADD',
							icon: '<?php echo base_url(); ?>/images/icons/user_add.png',
 							cls:'x-btn-text-icon',
 					     	...
 					     	xtype: 'tbbutton',
 					     	text: 'EDIT',
							icon: '<?php echo base_url(); ?>/images/icons/user_edit.png',
 							cls:'x-btn-text-icon',
 					     	...
 					     	xtype: 'tbbutton',
 					     	text: 'DELETE',
							icon: '<?php echo base_url(); ?>/images/icons/user_delete.png',
 							cls:'x-btn-text-icon',
 				...
 				tbar: [
 					    {
 					     	...
 					     	xtype: 'tbbutton',
 					     	text: 'ADD',
							icon: '<?php echo base_url(); ?>/images/icons/application_add.png',
 							cls:'x-btn-text-icon',
 					     	...
 					     	xtype: 'tbbutton',
 					     	text: 'DELETE',
							icon: '<?php echo base_url(); ?>/images/icons/application_delete.png',
 							cls:'x-btn-text-icon',
 		...
 		Add: function(){
 		    ...
 		    _window = new Ext.Window({
 		        ...
 		        buttons: [{
 		            ...
 		            text: 'Cancel',
                            icon: '<?php echo base_url(); ?>/images/icons/cancel.png',
 		            handler: function(){
 			            _window.destroy();
 		            }
 		        }]
 				...
 				tbar: [new Ext.form.ComboBox({
					...
					text:'Search:'
                                ...
                                '->',
                                {
                                    ...
                                    icon: '<?php echo base_url(); ?>/images/icons/accept.png',
                                    cls:'x-btn-text-icon',
                                    handler: function(){
 		        ...
 		        items: [ {
 		            ...
 		            id: 'description'
                        ...
                        buttons: [
                            {
                                text: 'ADD',
                                 icon: '<?php echo base_url(); ?>/images/icons/add.png',
                                 cls:'x-btn-text-icon',
                                handler: function () {
