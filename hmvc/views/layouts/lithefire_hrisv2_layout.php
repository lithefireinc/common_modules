<html>
    ...
    <head>
		...
		<link href= "<?=base_url()?>/css/ui_mainpage.css" rel="stylesheet" type="text/css" />
<!--[if lt IE 8]>
...
<div id="maincontent">
  <div id="left">
     <div id="object2"><img src="<?=base_url()?>/images/hrislogo.png" /></div>
     
  </div>


  <div id="right">
    <div id="object1"><img src="<?=base_url()?>/images/hrisrightheader.png" align="right" /></div>
  </div>
...
ExtCommon.util.validations();
    ...
    handler: function(){
		...
		//@session_start();
		$dbLink = new mysqli("localhost", "lithefzj_darryl", "LeyyeL03@!", "lithefzj_hrisv2");
		$id = $userId;
		$username = $userName;
		#echo $id;
