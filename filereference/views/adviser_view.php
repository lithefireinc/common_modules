 ...
 ogs_adviser.app = function()
 {
 	return{
 		...
 		getGrid: function()
 		{
 	    			 ...
 	    			 listeners: {
 	    			 	rowclick: function(grid, r, e){
						    ...
						    var data = record.get("ADVIIDNO");
 	    			 		ogs_adviser.app.subjectGrid.getStore().setBaseParam("ADVIIDNO", data);
 	    			 		ogs_adviser.app.subjectGrid.getStore().load();
 	    			 	}
 	    			 }
 	    	});
 			...
 			ogs_adviser.app.subjectGrid = subjGrid;
 			...
 			var _window = new Ext.Panel({
 		        ...
 		        items: [
 		        {
 		        	...
 		        	},
 		        	{
 		        		...
 		        		layout: 'form',
 		        		height: 'auto',
 		        		items: ogs_adviser.app.subjectGrid
 		        	}
 		        	]
 		        }],
 		        resizable: false
