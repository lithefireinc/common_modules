<script type="text/javascript">
 Ext.namespace("ogs_grade_entry_restriction");
 ogs_grade_entry_restriction.app = function()
 {
 	return{
 		init: function()
 		{
 		...
 		getGrid: function()
 		{
 			...
 			var Objstore = new Ext.data.Store({
 						proxy: new Ext.data.HttpProxy({
 							url: "<?=site_url("admin/getGradeEntryRestriction")?>",
 							method: "POST"
 							}),
 			...
 			var grid = new Ext.grid.GridPanel({
 				id: 'ogs_grade_entry_restrictiongrid',
 				height: 300,
 				width: 900,
 				border: true,
 				ds: Objstore,
 				cm:  new Ext.grid.ColumnModel(
 						[
 						  ...
 						  { header: "Semester", width: 150, sortable: true, dataIndex: "SEMESTER" },
                                                  { header: "Period", width: 150, sortable: true, dataIndex: "PERIOD" },
                                                  { header: "Date From", width: 100, sortable: true, dataIndex: "date_from" },
                                                  { header: "Date to", width: 150, sortable: true, dataIndex: "date_to" }
				...
				},'   ', new Ext.app.SearchField({ store: Objstore, width:250}),
 					    {
							...
							icon: '/images/icons/application_add.png',
 							cls:'x-btn-text-icon',
 					     	...
 					     	handler: ogs_grade_entry_restriction.app.Add
							...
							icon: '/images/icons/application_edit.png',
 							cls:'x-btn-text-icon',
 					     	...
 					     	handler: ogs_grade_entry_restriction.app.Edit
							...
							icon: '/images/icons/application_delete.png',
 							cls:'x-btn-text-icon',
 					     	...
 					     	handler: ogs_grade_entry_restriction.app.Delete

 					 	}
 	    			 ]
 	    	});

 			ogs_grade_entry_restriction.app.Grid = grid;
 			ogs_grade_entry_restriction.app.Grid.getStore().load({params:{start: 0, limit: 25}});

 			var _window = new Ext.Panel({
 		        title: 'Grade Entry Restriction',
 		        width: '100%',
 		        height:420,
 		        renderTo: 'mainBody',
 		        draggable: false,
 		        layout: 'fit',
 		        items: [ogs_grade_entry_restriction.app.Grid],
 		        resizable: false
 		    ...
 		    var form = new Ext.form.FormPanel({
 		        labelWidth: 150,
 		        url:"<?=site_url("admin/addGradeEntryRestriction")?>",
 		        method: 'POST',
 		        ...
 		        items: [ {
 					...
 					width:'auto',
 					height:'auto',
 					items:[ogs_grade_entry_restriction.app.semesterCombo(),
                    ...
                    store: new Ext.data.SimpleStore({
				        ...
				        ,fields:
				         ...
				         , data: [['PRELIM', 'PRELIM'], ['MIDTERM', 'MIDTERM'], ['FINAL', 'FINAL']]
                ...
                }),
                      {
				                		...
				                		//requests.app.setNoOfDays();
					                  	...
					                  	//requests.app.setNoOfDays();
                                                            ...
                                                            select: function(){
                                                              //  ogs_attendance.app.Grid.getStore().setBaseParam("date_from", this.getRawValue());
                                                            }
                                                            }
                                                      },
                      {
				                		...
				                		//requests.app.setNoOfDays();
					                  	...
					                  	//requests.app.setNoOfDays();
                                                            ...
                                                            select: function(){
                                                                //ogs_attendance.app.Grid.getStore().setBaseParam("date_to", this.getRawValue());
                                                            }
                                                            }
                                                       }
 		    ...
 		    ogs_grade_entry_restriction.app.Form = form;
 		},
 		Add: function(){

 			ogs_grade_entry_restriction.app.setForm();
 		    ...
 		    _window = new Ext.Window({
 		        ...
 		        buttonAlign:'center',
 		        items: ogs_grade_entry_restriction.app.Form,
 		        buttons: [{
 		         	text: 'Save',
                                icon: '/images/icons/disk.png',  cls:'x-btn-text-icon',

 	                handler: function () {
 			            if(ExtCommon.util.validateFormFields(ogs_grade_entry_restriction.app.Form)){//check if all forms are filled up

 		                ogs_grade_entry_restriction.app.Form.getForm().submit({
 			                success: function(f,action){
 				                ...
 				                ExtCommon.util.refreshGrid(ogs_grade_entry_restriction.app.Grid.getId());
 				                _window.destroy();
 			                },
 		...
 		Edit: function(){
 			...
 			if(ExtCommon.util.validateSelectionGrid(ogs_grade_entry_restriction.app.Grid.getId())){//check if user has selected an item in the grid
 			var sm = ogs_grade_entry_restriction.app.Grid.getSelectionModel();
 			var id = sm.getSelected().data.id;

 			ogs_grade_entry_restriction.app.setForm();
 		    var edit_window = new Ext.Window({
 		        title: 'Update Grade Entry Restriction',
 		        width: 510,
 		        height:250,
 		        layout: 'fit',
 		        plain:true,
 		        ...
 		        buttons: [{
 		            ...
 		            handler: function () {
 			            if(ExtCommon.util.validateFormFields(ogs_grade_entry_restriction.app.Form)){//check if all forms are filled up
 		                ogs_grade_entry_restriction.app.Form.getForm().submit({
 			                url: "<?=site_url("admin/updateGradeEntryRestriction")?>",
 			                params: {id: id},
 			                method: 'POST',
 			                success: function(f,action){
                 		    	Ext.MessageBox.alert('Status', action.result.data);
 		  	...
 		  	ogs_grade_entry_restriction.app.Form.getForm().load({
 				url: "<?=site_url("admin/loadGradeEntryRestriction")?>",
 				method: 'POST',
 				params: {id: id},
 				timeout: 300000,
 				waitMsg:'Loading...',
 ...
 Ext.onReady(ogs_grade_entry_restriction.app.init, ogs_grade_entry_restriction.app);
